...
const BATTING_PARTS: (keyof CharacterColors)[] = [
  "cap",
  "capAccent",
  "bat",
  "gloves",
...
const SCOOP_PARTS: (keyof CharacterColors)[] = [
  "cap",
  "capAccent",
  "bat",
  "gloves",
...
const BOWLING_PARTS: (keyof CharacterColors)[] = [
  "cap",
  "capAccent",
  "ball",
  "shoes",
];
const KEEPING_PARTS: (keyof CharacterColors)[] = [
  "cap",
  "capAccent",
  "gloves",
  "pads",
...
const KEEPING2_PARTS: (keyof CharacterColors)[] = [
  "cap",
  "capAccent",
  "gloves",
  "pads",
