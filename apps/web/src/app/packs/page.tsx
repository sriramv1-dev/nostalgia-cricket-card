    ...
    <main className="flex flex-col min-h-screen pb-20">
      ...
      <div className="sticky top-0 z-10 bg-gray-950/95 backdrop-blur-sm border-b border-gray-800 px-4 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="font-display text-3xl text-cream tracking-wider">PACK SHOP</h1>
            <p className="text-gray-500 text-xs">Spend coins, discover legends</p>
          </div>
          ...
          >
            ...
            <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-800">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-gold font-bold text-lg">{pack.price}</span>
