      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 text-center">
        <div className="bg-green-400/5 border border-green-400/20 rounded-2xl p-8 w-full max-w-xs">
          ...
          <p className="text-gray-400 text-sm mb-4 leading-relaxed">
            The trade floor is quiet right now. Once players list their cards
            for trade, offers will appear here.
          </p>
        ...
        <div className="mt-8 w-full max-w-xs text-left">
          ...
          <div className="space-y-3">
            {[
              {
                step: "1",
                text: 'Mark cards as "for trade" in your collection',
              },
              { step: "2", text: "Browse what others are offering" },
              {
                step: "3",
                text: "Propose a swap — offer your card, request theirs",
              },
